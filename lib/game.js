...
function generateCarsArray() {
  ...
  for (var i = 1; i < 13; i++) {
    switch (i === true) {
    case i > 3 :
      var carRow1 = new Cars(x, 600, 50, 40, -1)

      x += 200
      carsArray.push(carRow1);
      break
    case i > 6:
      var carRow2 = new Cars( x, 550, 50, 40, 2)

      x -= 200
      carsArray.push(carRow2)
      break
    case i > 9:
      var carRow3 = new Cars( x, 500, 50, 40, -2)

      x += 250
      carsArray.push(carRow3)
      break
    case i > 10:
      var carRow4 = new Cars( x, 450, 50, 40, 3)

      carsArray.push(carRow4)
      break
    case i > 12:
      var carRow5 = new Cars( x, 400, 100, 40, -2)
