...
var Frogking = require('./Frogking.js')
...
var kingFrog = new Frogking();

var kingFrogFlag = true;
...
var kingFrogArray = [];
kingFrogArray = kingFrog.generateKingFrogArray(frogger, docksToDraw)


console.log(kingFrogArray);
...
function startGame() {
  if (gameOver) {
    requestAnimationFrame(function gameLoop () {
      ...
      kingFrog.generateKingFrogArray(frogger, docksToDraw, kingFrogFlag)
      console.log(kingFrogArray);

      kingFrogArray.forEach(function(king) {
        king.drawKing(ctx);
      })
